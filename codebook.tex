...
\lstinputlisting[language=c++]{topological.cpp}

\subsection{Dijkstra}
\lstinputlisting[language=c++]{dijkstra.cpp}

\subsection{Bellman Ford}
\lstinputlisting[language=c++]{bellman_ford.cpp}
...
\subsection{Lowest Common Ancestor} % Jacob Plachta
...
\subsection{UFDS} % Stanford
\lstinputlisting[language=c++]{ufds.cpp}

\subsection{Sparse Table}
\lstinputlisting[language=c++]{sparsetable.cpp}
...
\subsection{Python modulo} % Brian Bi
\lstinputlisting[language=c++]{pythonMod.cpp}

\subsection{.vimrc} % Brian Bi
\lstinputlisting{vim.rc}
